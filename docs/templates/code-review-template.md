...
> Примечание:
> Определяй минимальный набор секций/пунктов, достаточный для полноты описания. Адаптируй шаблон под конкретную задачу, не удаляя placeholder’ы (до их заполнения) пояснения/примечания.